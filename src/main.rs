...
use crate::rdm::{
    ...
    DiscoveryRequest, GetRequest, PacketType, Response, ROOT_DEVICE, RdmCodec, RdmResponseMessage
};
...
async fn main() -> tokio_serial::Result<()> {
    ...
    tokio::spawn(async move {
        loop {
            ...
            //         if !Response::is_checksum_valid(&rdm_packet.to_vec()) {
            ...
            //         let response = Response::from(rdm_packet.to_vec().as_slice());
