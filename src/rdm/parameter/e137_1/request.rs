...
#[rdm_parameter(pid = ParameterId::DmxFailMode, command_class = CommandClass::Set)]
...
#[derive(Clone, Debug, PartialEq)]
#[rdm_parameter(pid = ParameterId::DmxStartupMode, command_class = CommandClass::Set)]
...
#[derive(Copy, Clone, Debug, PartialEq)]
#[rdm_parameter(pid = ParameterId::MinimumLevel, command_class = CommandClass::Set)]
...
#[derive(Copy, Clone, Debug, PartialEq)]
#[rdm_parameter(pid = ParameterId::MaximumLevel, command_class = CommandClass::Set)]
pub struct SetMaximumLevelRequest {
    pub maximum_level: u16,
}

#[derive(Copy, Clone, Debug, PartialEq)]
#[rdm_parameter(pid = ParameterId::Curve, command_class = CommandClass::Set)]
pub struct SetCurveRequest {
    pub curve_id: u8,
}

#[derive(Copy, Clone, Debug, PartialEq)]
#[rdm_parameter(pid = ParameterId::CurveDescription, command_class = CommandClass::Get)]
pub struct GetCurveDescriptionRequest {
    pub curve_id: u8,
}

#[derive(Copy, Clone, Debug, PartialEq)]
#[rdm_parameter(pid = ParameterId::OutputResponseTime, command_class = CommandClass::Set)]
pub struct SetOutputResponseTimeRequest {
    pub output_response_time_id: u8,
}

#[derive(Copy, Clone, Debug, PartialEq)]
#[rdm_parameter(pid = ParameterId::OutputResponseTimeDescription, command_class = CommandClass::Get)]
pub struct GetOutputResponseTimeDescriptionRequest {
    pub output_response_time_id: u8,
}

#[derive(Copy, Clone, Debug, PartialEq)]
#[rdm_parameter(pid = ParameterId::ModulationFrequency, command_class = CommandClass::Set)]
pub struct SetModulationFrequencyRequest {
    pub modulation_frequency_id: u8,
}

#[derive(Copy, Clone, Debug, PartialEq)]
#[rdm_parameter(pid = ParameterId::ModulationFrequencyDescription, command_class = CommandClass::Get)]
pub struct GetModulationFrequencyDescriptionRequest {
    pub modulation_frequency_id: u8,
}

#[derive(Copy, Clone, Debug, PartialEq)]
#[rdm_parameter(pid = ParameterId::BurnIn, command_class = CommandClass::Set)]
pub struct SetBurnInRequest {
    pub hours: u8,
}

#[derive(Copy, Clone, Debug, PartialEq)]
#[rdm_parameter(pid = ParameterId::LockPin, command_class = CommandClass::Set)]
...
#[derive(Clone, Debug, PartialEq)]
#[rdm_parameter(pid = ParameterId::LockState, command_class = CommandClass::Set)]
...
#[derive(Clone, Debug, PartialEq)]
#[rdm_parameter(pid = ParameterId::LockStateDescription, command_class = CommandClass::Get)]
pub struct GetLockStateDescriptionRequest {
    pub lock_state_id: u8,
}

#[derive(Copy, Clone, Debug, PartialEq)]
#[rdm_parameter(pid = ParameterId::IdentifyMode, command_class = CommandClass::Set)]
pub struct SetIdentifyModeRequest {
    pub identify_mode: u8, // TODO use enum
}

#[derive(Copy, Clone, Debug, PartialEq)]
#[rdm_parameter(pid = ParameterId::PresetStatus, command_class = CommandClass::Get)]
pub struct GetPresetStatusRequest {
    pub scene_id: u16,
}

#[derive(Copy, Clone, Debug, PartialEq)]
#[rdm_parameter(pid = ParameterId::PresetStatus, command_class = CommandClass::Set)]
...
#[derive(Copy, Clone, Debug, PartialEq)]
#[rdm_parameter(pid = ParameterId::PresetMergeMode, command_class = CommandClass::Set)]
pub struct SetPresetMergeModeRequest {
    pub merge_mode: MergeMode,
}

#[derive(Copy, Clone, Debug, PartialEq)]
#[rdm_parameter(pid = ParameterId::PowerOnSelfTest, command_class = CommandClass::Set)]
